...
def do_fix_fmt():
  lib.run_cmd('cargo fmt')
  lib.run_cmd('ruff format')


def do_check_fmt():
  lib.run_cmd('cargo fmt -- --check')
  lib.run_cmd('ruff format --check')
...
def do_btest(args=None):
  ...
  lib.run_cmd(' '.join(test_cmd))


def do_test():
  lib.run_cmd('cargo run -p boot_shell -- test core')


def do_check_history():
  lib.run_cmd('cog check')


def do_generate_changelog():
  lib.run_cmd('git cliff')
