...
This document defines the shared contributor standard for Pentagram.
...
For each aim, every contribution must fulfil both obligations to the extent applicable and practical:

- **Embody.** Realize the aim in the system being changed.
