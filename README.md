...
Pentagram is a language project for clear reasoning. This index gives the repository a short path to its governing documents, working systems, and operational tools.
